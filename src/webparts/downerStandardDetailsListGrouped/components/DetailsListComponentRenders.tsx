...
import { GroupHeaderFilter } from "./GroupHeaderFilter";
...
export const onGroupHeaderRender = (props: IGroupHeaderProps): JSX.Element => {
  props.onGroupHeaderClick = () => props.onToggleCollapse!(props.group!);

  return <GroupHeaderFilter {...props} />;
};
