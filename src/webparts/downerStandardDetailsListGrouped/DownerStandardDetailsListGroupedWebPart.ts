...
> {
  ...
  // public onRenderOrderedGroupByItems = (
  //   item: any,
  //   index: number
  // ): JSX.Element => {
  //   if (item) {
  //     return React.createElement("span", null, `${item} Level : ${index + 1}`);
  //   }
  // };
  ...
  protected async onPropertyPaneFieldChanged(
    ...
    if (propertyPath === "selectedListTitle" && newValue) {
      ...
      this.properties.selectedGroupByFields = [];
      ...
      this.properties.selectedViewFields = [];
      this.properties.selectedGroupByFields = [];
      this.properties.selectedGroupByFieldsMapped = [];
      this.properties.selectedSortByFields = [];
      this.context.propertyPane.refresh();
      ...
      this.context.propertyPane.refresh();
    } else if (propertyPath === "selectedGroupByFields" && newValue) {
      this.properties.selectedGroupByFieldsMapped = groupByFieldsMapper(
        newValue,
        this._listColumnOptions
      );
      this.context.propertyPane.refresh();
...

            {
              ...
              groupFields: [
                ...
                PropertyFieldMultiSelect("selectedGroupByFields", {
                  ...
                  selectedKeys: selectedGroupByFields,
